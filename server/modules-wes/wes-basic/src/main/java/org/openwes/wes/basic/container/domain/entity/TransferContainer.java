...
public class TransferContainer {
    ...
    public void unOccupy() {
        log.info("unOccupy transfer container id: {}, transfer container code: {}", this.id, this.transferContainerCode);
    ...
    public void lock() {
        log.info("lock transfer container id: {}, transfer container code: {}", this.id, this.transferContainerCode);
    ...
    public void unlock() {
        log.info("unlock transfer container id: {}, transfer container code: {}", this.id, this.transferContainerCode);
